define(['dart_sdk', 'packages/angular_tour_of_heroes/app_component.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/constants', 'packages/angular/src/core/metadata/view', 'packages/angular/src/core/linker/app_view_utils', 'packages/angular/src/core/linker/app_view', 'packages/angular/src/common/directives/ng_for', 'packages/angular_tour_of_heroes/src/hero_component.template', 'packages/angular_tour_of_heroes/src/hero_component', 'packages/angular_tour_of_heroes/app_component', 'packages/angular_tour_of_heroes/src/hero', 'packages/angular/src/di/reflector', 'packages/angular/angular.template', 'packages/angular_tour_of_heroes/src/hero.template', 'packages/angular_tour_of_heroes/src/mock_heroes.template'], function(dart_sdk, app_component$46css, view_type, constants, view, app_view_utils, app_view, ng_for, hero_component, hero_component$, app_component, hero, reflector, angular, hero$, mock_heroes) {
  'use strict';
